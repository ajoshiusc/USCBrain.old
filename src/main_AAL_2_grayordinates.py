...
MNIVol = '/ImagePTE1/ajoshi/code_farm/hybridatlas/aal_for_SPM8/aal_for_SPM8/ROI_MNI_V4_svreg_1mm.nii.gz'
...
outvol = 'colin27-AAL.label.nii.gz'
outmidl = 'colin27-AAL.left.mid.cortex.dfs'
outmidr = 'colin27-AAL.right.mid.cortex.dfs'
