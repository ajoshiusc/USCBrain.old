...
% left hemi
sub_label = readdfs('MNI152-Hammers_mith.left.mid.cortex.dfs');
...
outfile = 'BCI-Hammers_mith.left.mid.cortex.dfs';
writedfs(outfile,tar);
recolor_by_label(outfile,[],[]);

% right hemi
sub_label = readdfs('MNI152-Hammers_mith.right.mid.cortex.dfs');
...
outfile = 'BCI-Hammers_mith.right.mid.cortex.dfs';
writedfs(outfile,tar);
recolor_by_label(outfile,[],[]);
