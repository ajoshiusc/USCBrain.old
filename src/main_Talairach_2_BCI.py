...
MNIVol = '/usr/share/fsl/data/atlases/Talairach/Talairach-labels-1mm.nii.gz'
...
outvol = 'BCI-Talairach.label.nii.gz'
outmidl = 'BCI-Talairach.left.mid.cortex.dfs'
outmidr = 'BCI-Talairach.right.mid.cortex.dfs'
