...
''' map to bc sphere'''
bs.vertices, bs.faces = fsio.read_geometry('/big_disk/ajoshi/fs_sub/BCI_DNI_Atlas/surf/rh.sphere.reg')
bs = interpolate_labels(s, bs)
bci.vertices, bci.faces = fsio.read_geometry('/big_disk/ajoshi/fs_sub/BCI_DNI_Atlas/surf/rh.white')
bci.labels = bs.labels
writedfs('BCI_orig_rh.dfs', bci)


bci.vertices, bci.faces = fsio.read_geometry('/big_disk/ajoshi/fs_sub/BCI_DNI_Atlas/surf/rh.inflated')
...
bci_bst = readdfs('/home/ajoshi/BrainSuite19b/svreg/BCI-DNI_brain_atlas/BCI-DNI_brain.right.inner.cortex.dfs')
bci_bst = interpolate_labels(bci, bci_bst)
bci_bst_mid = readdfs('/home/ajoshi/BrainSuite19b/svreg/BCI-DNI_brain_atlas/BCI-DNI_brain.right.mid.cortex.dfs')
...
writedfs(outbasename + '.mid.right.dfs', bci_bst)

bci_bst_in = readdfs('/home/ajoshi/BrainSuite19b/svreg/BCI-DNI_brain_atlas/BCI-DNI_brain.right.inner.cortex.dfs')
bci_bst.vertices=bci_bst_in.vertices
writedfs(outbasename + '.inner.right.dfs', bci_bst)

bci_bst_p = readdfs('/home/ajoshi/BrainSuite19b/svreg/BCI-DNI_brain_atlas/BCI-DNI_brain.right.pial.cortex.dfs')
bci_bst.vertices = bci_bst_p.vertices
writedfs(outbasename + '.pial.right.dfs', bci_bst)
