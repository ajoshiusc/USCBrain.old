...
MNIVol = '/home/brainsuite/dsistudio/atlas/brodmann.nii.gz'
...
outvol = 'BCI-brodmann.label.nii.gz'
outmidl = 'BCI-Brodmann.left.mid.cortex.dfs'
outmidr = 'BCI-Brodmann.right.mid.cortex.dfs'
