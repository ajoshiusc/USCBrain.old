...
inputfile_R='/ImagePTE1/ajoshi/code_farm/pvcthickness/MRI_Economo/rh.economo.gcs'
...
inputfile_L='/ImagePTE1/ajoshi/code_farm/pvcthickness/MRI_Economo/lh.economo.gcs'
