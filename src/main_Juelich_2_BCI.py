...
MNIVol = '/usr/share/fsl/data/atlases/Juelich/Juelich-maxprob-thr0-1mm.nii.gz'
...
#map = '/ImagePTE1/ajoshi/code_farm/icbm152/mni_icbm152_nlin_asym_09c/icbm152_t1.svreg.map.nii.gz'

labelhdr = os.path.join(BrainSuitePath, 'svreg',
                        'BCI-DNI_brain_atlas', 'BCI-DNI_brain.label.nii.gz')
outvol = 'BCI-Juelich.label.nii.gz'
outmidl = 'BCI-Juelich.left.mid.cortex.dfs'
outmidr = 'BCI-Juelich.right.mid.cortex.dfs'
