...
MNIVol = '/ImagePTE1/ajoshi/BrainnetomeAtlas/BN_Atlas_246_1mm.nii.gz'

btvol = image.resample_to_img(
    MNIVol, '/ImagePTE1/ajoshi/code_farm/icbm152/mni_icbm152_nlin_asym_09c/icbm152_t1.svreg.label.nii.gz', interpolation='nearest')
btvol.set_data_dtype('int16')
btvol.to_filename('tmp_mni.nii.gz')
...
outvol = 'BCI-Brainnetome.label.nii.gz'
outmidl = 'MNI152-'+atlas_name+'.left.mid.cortex.dfs'
outmidr = 'MNI152-'+atlas_name+'.right.mid.cortex.dfs'


lmid = os.path.join(
    '/ImagePTE1/ajoshi/code_farm/icbm152/mni_icbm152_nlin_asym_09c/icbm152_t1.left.mid.cortex.svreg.dfs')
rmid = os.path.join(
    '/ImagePTE1/ajoshi/code_farm/icbm152/mni_icbm152_nlin_asym_09c/icbm152_t1.right.mid.cortex.svreg.dfs')
