...
MNIVol = '/ImagePTE1/ajoshi/code_farm/hybridatlas/aal2/aal2_1mm_svreg.nii.gz'
...
outvol = 'BCI-AAL2.label.nii.gz'
outmidl = 'BCI-AAL2.left.mid.cortex.dfs'
outmidr = 'BCI-AAL2.right.mid.cortex.dfs'
