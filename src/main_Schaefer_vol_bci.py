...
subbasename = '/home/ajoshi/BrainSuite19b/svreg/BCI-DNI_brain_atlas/BCI-DNI_brain'
...
for parcels, nets in itertools.product([100, 200, 300, 400, 500, 600, 700, 800, 900, 1000], [7, 17]):
    ...
    parc_name = 'Schaefer2018_'+str(parcels)+'Parcels_' + str(nets) + 'Networks'

    left_labels = readdfs('/ImagePTE1/ajoshi/code_farm/hybridatlas/src/BCI-DNI_'+parc_name+'.left.mid.cortex.dfs')
    right_labels = readdfs('/ImagePTE1/ajoshi/code_farm/hybridatlas/src/BCI-DNI_'+parc_name+'.right.mid.cortex.dfs')
    ...
    new_img.to_filename('/ImagePTE1/ajoshi/code_farm/hybridatlas/src'+'/BCI-DNI_'+parc_name+'.label.nii.gz')
